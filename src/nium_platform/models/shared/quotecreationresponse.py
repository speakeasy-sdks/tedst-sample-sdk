...
class QuoteCreationResponse:
    ...
    quote_type: Optional[shared_quotetype.QuoteType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('quoteType'), 'exclude': lambda f: f is None }})
