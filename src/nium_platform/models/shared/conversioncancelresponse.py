...
class ConversionCancelResponse:
    ...
    cancellation_reason: Optional[shared_cancellationreason.CancellationReason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cancellationReason'), 'exclude': lambda f: f is None }})
    ...
    status: Optional[shared_conversionstatus.ConversionStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
