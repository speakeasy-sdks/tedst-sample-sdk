...
import dataclasses
from .historicalrateerrorcodes400 import HistoricalRateErrorCodes400
...
class HistoricalRateErrorDetail400:
    ...
    code: Optional[HistoricalRateErrorCodes400] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})
