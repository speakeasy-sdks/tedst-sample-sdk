...
from ..shared import conversioncreationrequest as shared_conversioncreationrequest
from ..shared import conversioncreationresponse as shared_conversioncreationresponse
...
class CreateConversionRequest:
    ...
    conversion_creation_request: Union[Union[shared_conversioncreationrequest_with_quote_id.ConversionCreationRequestWithQuoteIDWithSourceAmount, shared_conversioncreationrequest_with_quote_id.ConversionCreationRequestWithQuoteIDWithDestinationAmount], Union[shared_conversioncreationrequest_with_currency_pair.ConversionCreationRequestWithCurrencyPairWithSourceAmount, shared_conversioncreationrequest_with_currency_pair.ConversionCreationRequestWithCurrencyPairWithDestinationAmount]] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
