...
@dataclasses.dataclass
class CreateConversionRequestBody:
...
class CreateConversionRequest:
    ...
    request_body: CreateConversionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""ConversionCreationRequest"""
...
class CreateConversionConversionCreationResponseCancellationReason(str, Enum):
...
class CreateConversionConversionCreationResponseConversionStatus(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CreateConversionConversionCreationResponse:
    r"""OK"""
    ...
    cancellation_reason: Optional[CreateConversionConversionCreationResponseCancellationReason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cancellationReason'), 'exclude': lambda f: f is None }})
    r"""Reason for a conversion cancellation.
      * `user_cancel`: User initiated cancellation.
      * `insufficient_fund`: Cancellation due to insufficient balance in the wallet at the time of conversion execution.
    """
    ...
    status: Optional[CreateConversionConversionCreationResponseConversionStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the conversion."""
...
class CreateConversionResponse:
    ...
    conversion_creation_response: Optional[CreateConversionConversionCreationResponse] = dataclasses.field(default=None)
    r"""OK"""
