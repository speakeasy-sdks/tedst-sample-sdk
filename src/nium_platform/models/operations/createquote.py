...
from ..shared import quotecreationrequest as shared_quotecreationrequest
from ..shared import quotecreationresponse as shared_quotecreationresponse
...
class CreateQuoteRequest:
    ...
    quote_creation_request: Union[shared_quotecreationrequest.QuoteCreationRequestWithNoAmount, shared_quotecreationrequest.QuoteCreationRequestWithSourceAmount, shared_quotecreationrequest.QuoteCreationRequestWithDestinationAmount] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
