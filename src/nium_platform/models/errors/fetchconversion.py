...
class FetchConversion500ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class FetchConversion500ApplicationJSON(Exception):
    r"""Error response when service has internal error."""
    error_details: Optional[List[FetchConversion500ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
...
class FetchConversion404ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class FetchConversion404ApplicationJSON(Exception):
    r"""Error response when the requested resource cannot be found."""
    error_details: Optional[List[FetchConversion404ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    r"""Raw HTTP response; suitable for custom response parsing"""
...
class FetchConversion403ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class FetchConversion403ApplicationJSON(Exception):
    r"""Error response when the requested resource is forbidden."""
    error_details: Optional[List[FetchConversion403ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    r"""Raw HTTP response; suitable for custom response parsing"""
...
class FetchConversion401ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class FetchConversion401ApplicationJSON(Exception):
    r"""Error response when the request is unauthorized."""
    error_details: Optional[List[FetchConversion401ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    r"""Raw HTTP response; suitable for custom response parsing"""
...
class FetchConversion400ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class FetchConversion400ApplicationJSON(Exception):
    r"""Error response when the request format is invalid."""
    error_details: Optional[List[FetchConversion400ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    r"""Raw HTTP response; suitable for custom response parsing"""
