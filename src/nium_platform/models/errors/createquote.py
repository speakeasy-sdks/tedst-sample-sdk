...
class CreateQuote500ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class CreateQuote500ApplicationJSON(Exception):
    r"""Error response when service has internal error."""
    error_details: Optional[List[CreateQuote500ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
...
class CreateQuote404ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class CreateQuote404ApplicationJSON(Exception):
    r"""Error response when the requested resource cannot be found."""
    error_details: Optional[List[CreateQuote404ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    r"""Raw HTTP response; suitable for custom response parsing"""
...
class CreateQuote403ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class CreateQuote403ApplicationJSON(Exception):
    r"""Error response when the requested resource is forbidden."""
    error_details: Optional[List[CreateQuote403ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    r"""Raw HTTP response; suitable for custom response parsing"""
...
class CreateQuote401ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class CreateQuote401ApplicationJSON(Exception):
    r"""Error response when the request is unauthorized."""
    error_details: Optional[List[CreateQuote401ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    r"""Raw HTTP response; suitable for custom response parsing"""
...
class CreateQuote400ApplicationJSONErrorDetailsCode(str, Enum):
...
@dataclasses.dataclass
class CreateQuote400ApplicationJSON(Exception):
    r"""Error response when the request format is invalid."""
    error_details: Optional[List[CreateQuote400ApplicationJSONErrorDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorDetails'), 'exclude': lambda f: f is None }})
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    r"""Raw HTTP response; suitable for custom response parsing"""
