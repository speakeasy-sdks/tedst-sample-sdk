...
import dataclasses
from ..errors import historicalrateerrorcodes400 as errors_historicalrateerrorcodes400
...
class HistoricalRateErrorDetail400:
    r"""error details description"""
    code: Optional[errors_historicalrateerrorcodes400.HistoricalRateErrorCodes400] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})
