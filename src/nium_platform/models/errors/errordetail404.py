...
import dataclasses
from ..errors import errorcodes404 as errors_errorcodes404
...
class ErrorDetail404:
    ...
    code: Optional[errors_errorcodes404.ErrorCodes404] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})
